...
assert r.status_code == 200, f"STATUS CODE ERROR : {r.status_code}, content : {r.content}"
assert r.json()["Rennes"] == "Paris", "Wrong departure for test9"
assert r.json()["Paris"] == "Rennes", "Wrong destination for test9"
...
assert r.status_code == 200, f"STATUS CODE ERROR : {r.status_code}, content : {r.content}"
assert r.json()["Rennes"] == "Paris", "Wrong departure for test10"
assert r.json()["Paris"] == "Rennes", "Wrong destination for test10"
...
assert r.status_code == 200, f"STATUS CODE ERROR : {r.status_code}, content : {r.content}"
assert r.json()["Rennes"] == "Paris", "Wrong departure for test11"
assert r.json()["Paris"] == "Rennes", "Wrong destination for test11"
